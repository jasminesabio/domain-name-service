const main = async () => {
    ...
    await txn.wait();
    console.log("Minted domain helloworld.jas");

    txn = await domainContract.setRecord("helloworld", "Greetings from the first .jas minter.");
    await txn.wait();
    console.log("Set record for helloworld.jas");
